...
$CONFIG = '{"lang":"vi","error_reporting":true,"show_hidden":true,"hide_Cols":false,"theme":"light"}';
...
$auth_users = array(
    'admin' => '$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO', //12345
);
            ...
            ?>
                <tr>
                    ...
                    <td data-sort=<?php echo fm_enc($f) ?>>
                        <div class="filename">
                            ...
                            if (in_array(strtolower(pathinfo($f, PATHINFO_EXTENSION)), array('gif', 'jpg', 'jpeg', 'png', 'bmp', 'ico', 'svg', 'webp', 'avif'))): ?>
                                ...
                                <?php else: ?>
                                    <a href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($f) ?>&env=ace" title="<?php echo $f ?>">
                                    <?php endif; ?>
                    ...
                    <td class="inline-actions">
                        ...
                        class="edit-file"><i class="fa fa-pencil-square"></i>
                    </a>
